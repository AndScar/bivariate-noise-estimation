function [absolute_noise,perc_noise,raw_abs_noise,Apen,rgrid]=Ricerca_rumore_multifit_2(X,dim,ris,range)

[Raw_Absolute_noise,Raw_Noise_derivative,Apen,rgrid]=Ricerca_rumore_multivariato_2(X,dim,ris,range);
Apen=smooth(Apen);
scala=(ris:ris:1);
